...
(function($){	
	...
	_lang = {
			ans:{	// _lang.ans are shown during the display of .q-result, the answer result.
				corrAns: "Jawaban yang benar adalah:",
				praise: 'Jawaban Benar!',
				retry: 'Salah',
				whyAns: "Info:",
			...
			btn:{	// [ "text", "title" ]
				begin: [ "Mulai Ujian" ],
				check: [ "Jawab", "Lihat Jawaban Anda" ],
				del: [ "Hapus", "Hapus Hasil" ],
				help: [ "Petunjuk", 'Buka Petunjuk'],
				next: [ "Lanjut", "Pertanyaan Selanjutnya" ],
				restart: [ "Ulangi", "Ulangi Test" ],
				details: [ "Detail", "Lihat Detaik Nilai" ],
				review: [ "Pembahasan", "Pembahasan Pertanyaan" ],
				showOnlyMissed: [ " *", "Klik untuk menampilkan pertanyaan salah" ],
				quit: [ "Keluar", "Keluar Ujian" ],
				quitNo: [ "->", "Kembali" ],
				quitYes: [ '', "Ya, Keluar" ]
			},
			err:{
